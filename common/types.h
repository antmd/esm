...
/******************************************************************
* Handling for mutrade since they have used different sets        *
* of naming convention and #define                                *
******************************************************************/

/*
#ifndef UNSIGNED_SHORT
  #define UNSIGNED_SHORT uint16_t
#endif

#ifndef UNSIGNED_CHARACTER 
  #define UNSIGNED_CHARACTER unsigned char
#endif

#ifndef UNSIGNED_INTEGER  
  #define UNSIGNED_INTEGER uint32_t
#endif

#ifndef UNSIGNED_LONG  
  #define UNSIGNED_LONG uint64_t // Yea i have define long as 32 and mutrade as 64
#endif
*/

/******************************************************************
* End of handling for mutrade                                     *
******************************************************************/
#endif
