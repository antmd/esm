...
namespace ESM { namespace NSE
{
  void ReplyApplication::sendNewConfirm( OrderPtr order ) 
  {
    ...
    FIX42::ExecutionReport fixReport ( FIX::OrderID ( order->getOrderId() ),
                                      FIX::ExecID ( "1" ), //idGenerator.generateExecutionId() ) ,
  ...
  void ReplyApplication::sendReplaceConfirm( OrderPtr order ) 
  {
    ...
    void ReplyApplication::sendCancelConfirm( OrderPtr order, const std::string &reason )
  {
  ...
  void ReplyApplication::sendNewReject( OrderPtr order, const std::string &reason )
  {
  ...
  void ReplyApplication::sendReplaceReject( OrderPtr order, const std::string &reason )
  {
  ...
  void ReplyApplication::sendCancelReject( OrderPtr order, const std::string &reason )
  {
  ...
  void ReplyApplication::sendFillConfirm( OrderPtr order ) 
  {
    ...
    /*****************************  OUTBOUND  ***********************************
      ...
      437  ContraTradeQty                  2                        
      438  ContraTradeTime                 20130126-05:17:42.707    
